...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="hero" id="top">
      ...
      <div className="hero-grid"><div className="hero-copy-block"><h1>YOU JUST SPENT<br />FIVE FIGURES<br />ON A BOOTH.<br /><em>WHAT HAPPENS<br />AFTER EVERYONE<br />LEAVES?</em></h1><p className="hero-copy">We build a unique QR flow that turns every booth visitor into a real action: content, product use or qualified investment interest.</p></div><div className="hero-object"><div className="object-label"><span>COMPOUND / LIVE</span><span>01</span></div><div className="object-content"><span className="object-kicker">AFTER YOUR EVENT</span><strong>WHAT<br />HAPPENS<br />NEXT.</strong><small>Choose a path / Complete an action / Get a reward</small></div><div className="object-footer"><span>Attention</span><b>→</b><span>Continued value</span></div></div></div>
