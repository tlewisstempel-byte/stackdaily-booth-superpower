...
const paths: Record<PathId, { label: string; title: string; copy: string; action: string; reward: string }> = {
  creator: { label: "CREATOR", title: "Create content about you.", copy: "They post or submit a draft. You set their reward and receive content you can use.", action: "SUBMIT A POST", reward: "Creator reward" },
  builder: { label: "BUILDER", title: "Use your product.", copy: "They sign up and complete your product task. You give them credits or access for doing it.", action: "USE YOUR PRODUCT", reward: "Product credits" },
  investor: { label: "INVESTOR", title: "Open your deck.", copy: "They complete a short product quiz. You share your deck with people who want to see it.", action: "TAKE PRODUCT QUIZ", reward: "Investor deck" }
};
...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="hero" id="top">
      ...
      <div className="hero-grid"><div className="hero-copy-block"><h1>YOU JUST SPENT<br />FIVE FIGURES<br />ON A BOOTH.<br /><em>WHAT HAPPENS<br />AFTER THEY LEAVE?</em></h1><p className="hero-copy">We build what happens next, so your booth keeps creating value after your event.</p></div><div className="hero-object"><div className="object-label"><span>STACKDAILY / LIVE</span><span>01</span></div><div className="object-content"><span className="object-kicker">AFTER YOUR EVENT</span><strong>WHAT<br />HAPPENS<br />NEXT.</strong><small>Action / Reward / Value</small></div><div className="object-footer"><span>Attention</span><b>→</b><span>Continued value</span></div></div></div>
