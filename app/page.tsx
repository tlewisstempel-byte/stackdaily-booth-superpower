...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="section entry-section"><div className="section-label"><span>03</span><span>THE HANDOFF</span></div><div className="handoff-grid"><div className="handoff-card"><span>CONTENT ROUTE</span><strong>They arrive<br />already interested.</strong><p>They choose a path from the content plan and pick it up at the booth.</p></div><div className="handoff-card handoff-card--light"><span>BOOTH ROUTE</span><strong>They scan<br />and enter.</strong><p>They discover the activation in person and choose the same path.</p></div></div><div className="handoff-footer"><p>You receive the selected path and the completed product action.</p><a className="button button-red button-small" href="/book">TALK TO US TO MAKE YOUR BOOTH YOUR SUPERPOWER <span>→</span></a></div></section>
