...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <div className="value-strip"><div><span>THEY GET</span><strong>A reason to complete the action.</strong></div><b>↔</b><div><span>YOU GET</span><strong>A reason to follow up.</strong></div></div>
