...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="hero" id="top">
      ...
      <div className="hero-grid"><div className="hero-copy-block"><h1>YOU JUST SPENT<br />FIVE FIGURES<br />ON A BOOTH.<br /><em>WHAT HAPPENS<br />AFTER EVERYONE<br />LEAVES?</em></h1><p className="hero-copy">We build what happens next, so your booth keeps creating value after your event.</p></div><div className="hero-object"><div className="object-label"><span>STACKDAILY / LIVE</span><span>01</span></div><div className="object-content"><span className="object-kicker">AFTER YOUR EVENT</span><strong>WHAT<br />HAPPENS<br />NEXT.</strong><small>Action / Reward / Value</small></div><div className="object-footer"><span>Attention</span><b>→</b><span>Continued value</span></div></div></div>
      <div className="scroll-cue"><span>SCROLL TO SEE YOUR FLOW</span><span>↓</span></div>
    </section>

    <div className="value-strip"><div><span>EVENT SPEND</span><strong>Attention at your event.</strong></div><b>→</b><div><span>CONTINUED VALUE</span><strong>Something useful after your event.</strong></div></div>

    <section className="trusted-section" aria-label="Trusted by"><div className="trusted-heading"><span>TRUSTED BY</span><span>STACKDAILY / SELECTED WORK</span></div><div className="trusted-viewport"><div className="trusted-track" aria-hidden="true">{[...logos, ...logos].map(([name, src], index) => <div className="trusted-logo" key={`${src}-${index}`}><img src={src} alt={name} /></div>)}</div></div></section>

    <section className="section nurture-section" id="nurture"><div className="section-label"><span>01</span><span>WHAT WE BUILD</span></div><div className="section-grid"><div><h2>WE BUILD<br />REAL VALUE<br />FROM EVERY<br /><em>BOOTH VISITOR.</em></h2></div><div><p className="section-lead">Your booth brings people to you. We build the flow that retains value for you after they leave.</p><p className="section-copy">You tell us what you want from visitors. We set action and reward, then put it behind your QR code.</p><div className="feature-row"><div><span>ACTION</span><p>What you want someone to do after your booth.</p></div><div><span>REWARD</span><p>What they unlock when they finish it.</p></div></div><div className="evidence-block"><div className="evidence-heading"><span>RECENT CAMPAIGN EVIDENCE</span><p>Numbers from work we’ve already run across streams, workshops and challenges.</p></div><div className="evidence-grid"><div className="evidence-card"><strong>1,400+</strong><span>Telegram community members</span></div><div className="evidence-card"><strong>1,500</strong><span>average views per stream</span></div><div className="evidence-card"><strong>150+</strong><span>average workshop registrations</span></div><div className="evidence-card"><strong>80K</strong><span>activation impressions</span></div><div className="evidence-card"><strong>$6.62</strong><span>CPM on challenge campaigns</span></div><div className="evidence-card"><strong>$1.49</strong><span>average CPA on signup challenges</span></div></div><p className="evidence-note">From existing StackDaily campaigns.</p></div><div className="cta-row"><a className="text-cta" href="#activation">SEE EXAMPLES <span>→</span></a><a className="button button-red button-small" href="/book">TALK TO US TO MAKE YOUR BOOTH YOUR SUPERPOWER <span>→</span></a></div></div></div></section>
