...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="section entry-section" id="after-event"><div className="section-label"><span>03</span><span>AFTER THE BOOTH</span></div><div className="section-grid"><div><h2>THEY LEAVE<br />WITH VALUE.<br />YOU RECEIVE <em>VALUE.</em></h2></div><div><p className="section-lead">Most booth visits end with a generic form to fill out.</p><p className="section-copy">Different attendees take different paths and have different value that they can provide. We allow them to unlock value for themselves and provide value to you. That means:</p><ul className="value-list"><li><span>CREATORS</span> create content about you.</li><li><span>BUILDERS</span> use your product.</li><li><span>INVESTORS</span> receive information about it.</li></ul><div className="cta-row"><a className="button button-red button-small" href="/book">TALK TO US TO MAKE YOUR BOOTH YOUR SUPERPOWER <span>→</span></a></div></div></div></section>
